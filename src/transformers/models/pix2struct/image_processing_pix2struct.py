...
class Pix2StructImageProcessor(BaseImageProcessor):
    ...
    def extract_flattened_patches(self, image: np.ndarray, max_patches: int, patch_size: dict, **kwargs) -> np.ndarray:
        ...
        return result, resized_width, resized_height
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        encoded_outputs = BatchFeature(
            data={"flattened_patches": images, "attention_mask": attention_masks, 'width': width, 'height': height}, tensor_type=return_tensors
        )
