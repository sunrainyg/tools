...
#     from torchscale.component.flash_attention_triton import flash_attn_func
#     from torchscale.component.flash_attention_triton_sparse import flash_attn_sparse_func
# else:
#     from torchscale.component.flash_attention_xformers import flash_attn_func
...
class Pix2StructVisionAttention(nn.Module):
    ...
    def forward(
        ...
        # attn_weights, _ = flash_attn_func(query_states, key_states, value_states, position_bias_masked, False, None)
        attn_weights = memory_efficient_attention(query_states, key_states, value_states, position_bias_masked)
