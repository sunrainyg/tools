...
def top1gating(
    ...
    use_xmoe=False,
    gate_obj=None,
    # moe_expert_noise_threshold=0.0,
...
class Top1Gate(torch.nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.args = args
        self.binary_routing = getattr(args, "binary_routing", False)
        if use_xmoe:
        ...
        elif self.binary_routing:
            assert 2 ** int(math.log2(num_experts)) == num_experts
            self.wg = torch.nn.Linear(model_dim, int(math.log2(num_experts)), bias=False)
            # self.code_mask = 2 ** torch.arange(int(math.log2(num_experts)) - 1, -1, -1)
            self.loss_mask = create_combinations(num_experts)
        else:
    ...
    #     self.num_updates = 0
    #     self.moe_expert_noise_threshold = args.moe_expert_noise_threshold
    #     self.moe_expert_noise_threshold_init = args.moe_expert_noise_threshold_init
    #     self.moe_expert_noise_threshold_warmup = args.moe_expert_noise_threshold_warmup

    # def set_num_updates(self, num_updates):
    #     self.num_updates = num_updates

    # def get_expert_noise_threshold(self):
    #     if self.training:
    #         if self.moe_expert_noise_threshold_warmup == 0:
    #             return self.moe_expert_noise_threshold
    #         else:
    #             if self.num_updates < self.moe_expert_noise_threshold_warmup:
    #                 res = self.moe_expert_noise_threshold_init + (self.moe_expert_noise_threshold - self.moe_expert_noise_threshold_init) / self.moe_expert_noise_threshold_warmup * self.num_updates
    #                 return res
    #             else:
    #                 return self.moe_expert_noise_threshold
    #     else:
    ...
    def forward(self, input, mask=None):  # type: ignore
        ...
        return top1gating(
            ...
            gate_obj=self,
            # moe_expert_noise_threshold=self.get_expert_noise_threshold(),
        )
...
class Top2Gate(torch.nn.Module):
    ...
    def __init__(
        ...
        self.use_xmoe = use_xmoe
        self.args = args
    #     self.moe_second_expert_threshold = args.moe_second_expert_threshold
    #     self.moe_second_expert_threshold_warmup = args.moe_second_expert_threshold_warmup
    #     self.moe_second_expert_threshold_init = args.moe_second_expert_threshold_init
    #     self.num_updates = 0
    #     self.moe_expert_noise_threshold = args.moe_expert_noise_threshold
    #     self.moe_expert_noise_threshold_init = args.moe_expert_noise_threshold_init
    #     self.moe_expert_noise_threshold_warmup = args.moe_expert_noise_threshold_warmup
    ...
    # def get_second_expert_threshold(self):
    #     if self.training:
    #         if self.moe_second_expert_threshold_warmup == 0:
    #             return self.moe_second_expert_threshold
    #         else:
    #             if self.num_updates < self.moe_second_expert_threshold_warmup:
    #                 res = self.moe_second_expert_threshold_init + (self.moe_second_expert_threshold - self.moe_second_expert_threshold_init) / self.moe_second_expert_threshold_warmup * self.num_updates
    #                 return res
    #             else:
    #                 return self.moe_second_expert_threshold
    #     else:
